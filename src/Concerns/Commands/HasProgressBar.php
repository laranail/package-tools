...
/**
 * HasProgressBar - Trait for adding progress bars to commands
 *
 * Provides methods for creating and managing progress bars with
...
trait HasProgressBar
{
    ...
    public function startProgress(int $steps, ?string $format = null): void
    {
        ...
        // Set custom format or use default
