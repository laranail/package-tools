...
/**
 * HasLifecycleHooks - Package lifecycle hooks and events
 *
 * Provides lifecycle hooks for:
 * - onBeforeRegister / onAfterRegister
 * - onBeforeBoot / onAfterBoot
 * - onBeforeConfigLoad / onAfterConfigLoad
 * - onBeforeViewLoad / onAfterViewLoad
 */
trait HasLifecycleHooks
{
     ...
     * @example
     * ```php
     * $package->onBeforeRegister(function(Package $package) {
     *     Log::info('Registering package: ' . $package->name);
     * });
     * ```
     */
