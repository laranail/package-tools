...
/**
 * HasAssetPublisher - Advanced asset publishing with directory cleanup
 *
 * Provides enhanced asset management with:
 * - Registry of published assets
 * - Optional directory cleanup before publishing
 * - Batch asset publishing
 * - Asset versioning support
 * - Standard asset type conventions
 * - Asset groups
 */
trait HasAssetPublisher
{
     ...
     * ```php
     * $package->publishAssets('resources/assets', 'vendor/blog', cleanBeforePublish: true);
     * ```
     */
    ...
    /**
     * Publish module assets using standard conventions
     *
     * Automatically publishes assets based on standard types:
     * - 'all': Publishes entire public directory
     * - 'js': JavaScript files
     * - 'css': Stylesheets
     * - 'images': Image files
     * - 'media': Media files (images, videos, etc.)
     * - 'fonts': Font files
     * - 'vendors': Third-party vendor assets
     *
     * @param array<string>|string $types Asset type(s) to publish
     * @param bool $cleanBeforePublish Clean before publishing
     *
     * @example Publish all assets
     * ```php
     * $package->publishModuleAssets('all');
     * ```
     * @example Publish specific types
     * ```php
    ...
    /**
     * Publish asset groups
     *
     * Groups assets for organized publishing. Each group can contain multiple assets.
     *
    ...
    /**
     * Publish custom assets with flexible mapping
     *
