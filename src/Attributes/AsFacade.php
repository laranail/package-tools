 ...
 *
 * Use with `Package::discoversWithAttributes()` and
 * `FacadeAutoGenerator` (Phase 5C). The Package builder will create a
 * `Facade`-extending class and register the alias.
 *
 * Example:
 * ```
 * #[AsFacade(alias: 'Foo')]
