 ...
 * standards-compliant CycloneDX SBOM (spec 1.5, JSON serialisation).
 * No shelling out — every byte is computed in-process so the output is
...
final readonly class SbomGenerator
{
     ...
     * we do not require the file to exist yet.
     */
