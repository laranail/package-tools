...
/**
 * PatternResolver - Resolves dynamic patterns with variables
 *
 * Enables configuration-driven pattern resolution for namespaces,
 * tags, paths, and other dynamic values.
 */
class PatternResolver implements ResolverInterface
{
     ...
     * @param array $variables Key-value pairs of variable replacements
    ...
    /**
     * `ResolverInterface::canResolve` — returns true when `$input` declares
     * at least one `{variable}` placeholder that this resolver knows how
     * to substitute (i.e. is in the `availableVariables` allow-list).
     */
