 ...
 *
 * Idempotent — the same registry can attach repeatedly without
 * stacking duplicate listeners. WeakReference is used so the hook
 * holds no strong reference to the registry / executor pair.
 */
