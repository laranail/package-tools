...
/**
 * AssetRegistry - Asset tracking and cleanup management
 *
 * Tracks published assets and manages cleanup operations
 */
class AssetRegistry implements RegistryInterface
{
    ...
    {
        return isset($this->cleanupTargets[$tag]) && ! empty($this->cleanupTargets[$tag]);
    }
