 ...
 * operations: memory limits, execution time, INI settings, and disabling
 * debugging tools (Telescope, Xdebug, Clockwork, Debugbar). Use scope()
 * to apply settings for the duration of a callback and restore them after.
 *
