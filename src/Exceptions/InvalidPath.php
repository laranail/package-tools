...
/**
 * InvalidPath - Path validation exceptions
 *
 * **IMPROVEMENT #3: Enhanced Validation**
 *
 * Provides detailed error messages for path-related configuration issues.
 * Helps developers quickly identify and fix common package setup problems.
 */
class InvalidPath extends Exception
{
     ...
     *
     * @param array $missingItems List of missing directories/files
     * @param string $basePath The package base path
     */
